...
container.register("bootstrapAsync", require("./bootstrap"));
...
container.register("loadSchema", require("./load-schema"));
...
container.register("schemaUninitialized", require("./schema"));
